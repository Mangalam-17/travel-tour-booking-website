...
const team = [
  ...
  },
  {
    ...
    bio: 'Former travel journalist who curates every itinerary with an obsessive eye for detail and authenticity.',
  },
  {
    name: 'Daniel Osei',
    role: 'Operations Director',
    image: 'https://i.pravatar.cc/200?img=15',
    bio: 'Logistics expert ensuring every transfer, hotel, and activity runs like clockwork across all destinations.',
  },
  {
    name: 'Sofia Reyes',
    role: 'Customer Experience Lead',
    image: 'https://i.pravatar.cc/200?img=47',
    bio: 'Dedicated to making sure every traveler feels supported before, during, and after their journey.',
  },
];
...
const milestones = [
  ...
  { year: '2024', event: 'Serving 50,000+ travelers across 150+ destinations worldwide.' },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeUp}>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-slate-800 mb-6">
                Making the World Accessible to Every Traveler
              </h2>
              <p className="text-slate-600 leading-relaxed mb-5">
                We believe extraordinary travel shouldn't be reserved for the few. Our mission is to
                make world-class experiences accessible, affordable, and stress-free — so you can
                focus entirely on the joy of discovery.
              </p>
              <p className="text-slate-600 leading-relaxed mb-8">
                Every tour we design is the result of months of on-the-ground research, local
                partnerships, and relentless attention to detail. We don't just book trips — we
                engineer memories.
              </p>
              <Link
                to="/destinations"
