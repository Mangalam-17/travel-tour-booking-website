...
const featuredDestinations = [
  { name: 'Rajasthan', country: 'India', image: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?w=600&q=80', tours: 3, rating: 4.9 },
  { name: 'Kerala', country: 'India', image: 'https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?w=600&q=80', tours: 2, rating: 4.8 },
  { name: 'Goa', country: 'India', image: 'https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?w=600&q=80', tours: 2, rating: 4.7 },
  { name: 'Ladakh', country: 'India', image: 'https://images.unsplash.com/photo-1626621341517-bbf3d9990a23?w=600&q=80', tours: 2, rating: 4.9 },
  { name: 'Varanasi', country: 'India', image: 'https://images.unsplash.com/photo-1561361058-c24cecae35ca?w=600&q=80', tours: 1, rating: 4.8 },
  { name: 'Andaman', country: 'India', image: 'https://images.unsplash.com/photo-1586500036706-41963de24d8b?w=600&q=80', tours: 1, rating: 4.8 },
];
...
const whyUs = [
  ...
  { icon: '🇮🇳', title: '50+ Indian Destinations', desc: 'From the Himalayas to Kanyakumari, we cover every corner of India.' },
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <p className="text-orange-100 text-lg mb-8 max-w-xl mx-auto">
              Join over 50,000 happy travelers who've explored Incredible India with Roamly.
            </p>
            <Link
              to="/destinations"
