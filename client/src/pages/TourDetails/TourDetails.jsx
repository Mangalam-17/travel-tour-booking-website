            ...
            >
              ...
              <div className="space-y-4">
                {tour.reviews.map((review) => (
                    <div key={review._id || review.id} className="flex gap-3 p-4 bg-slate-50 rounded-xl">
                    <img
                      src={review.avatar}
                      alt={review.name}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center justify-between gap-1 mb-1">
                        <span className="font-semibold text-slate-800 text-sm truncate">{review.name}</span>
